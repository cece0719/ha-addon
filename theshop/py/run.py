...
if __name__ == "__main__":
    ...
    devices: List[Device] = [
        ...
        DeviceBoiler(1, "1", ["1"], mqtt.publish, serial.send),
        DeviceBoiler(2, "2", ["2"], mqtt.publish, serial.send),
        DeviceBoiler(3, "3", ["3"], mqtt.publish, serial.send),
        DeviceBoiler(4, "4", ["4"], mqtt.publish, serial.send),
        DeviceBoiler(5, "5", ["5"], mqtt.publish, serial.send),
